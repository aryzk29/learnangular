...
export class AuthService {
  ...
  login(email: string, password: string) {
    return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCxec800GIbIJrFcV7omO3uQ215qfsoJpo',
        {
          email: email,
          password: password,
          returnSecureToken: true
